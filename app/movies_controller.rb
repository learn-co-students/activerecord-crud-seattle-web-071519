...
def can_find_the_first_item_from_the_database_using_id
  first=Movie.find_by(id: 1)
  first
end

def can_find_by_multiple_attributes
  data= Movie.find_by(title: "Title", release_date: 2000, director: "Me")
  # Search Values:
  # title == "Title"
  # release_date == 2000
  # director == "Me
...
def can_be_found_updated_and_saved
  ...
  updated= Movie.update(:title=> "Even Awesomer Flick")
  updated
...
def can_update_using_update_method
  ...
  updated= Movie.update(:title=> "Wat, huh?")
  updated
end
